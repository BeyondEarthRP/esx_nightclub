Locales['en'] = {
    ...
    ['jagercerbere']             = 'Jager Cerbere',
    ['assembling_cocktail']      = 'Mixing of different ingredients in progress!',
    ['craft_miss']               = 'Unhappy failure of a mixture ...',
    ['not_enough']               = 'Not enough ~r~ ',
    ['craft']                    = 'Finished with mixing of ~g~',
